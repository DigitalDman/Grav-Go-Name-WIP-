...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        ########################
        #Intangability
        self.Intangability = False
        #Gravity
        self.gravity_100 = 0.35
        self.gravity_200 = 1
        self.gravity_75 = 0.2625
        self.gravity_50 = 0.175
        self.gravity_25 = 0.0875
        self.gravity_0 = -1
        ...
        self.passed = False
        self.friction = -.12  
        self.position, self.velocity = pygame.math.Vector2(755,1450), pygame.math.Vector2(0,0) #Normal pos = 665, 3000
        self.acceleration = pygame.math.Vector2(0,self.gravity_100)
    ...
    def load_frames(self):
        ...
        self.idle_frames_left = [my_spritesheet.parse_sprite("player.png"),
                                 my_spritesheet.parse_sprite("boss.png")]
        self.walking_frames_left = [my_spritesheet.parse_sprite("player.png"), my_spritesheet.parse_sprite("boss_left.png"),
                           my_spritesheet.parse_sprite("player.png"), my_spritesheet.parse_sprite("player.png"),
                           my_spritesheet.parse_sprite("player.png"), my_spritesheet.parse_sprite("player.png"),
                           my_spritesheet.parse_sprite("player.png"), my_spritesheet.parse_sprite("player.png")]
